...
(
    id         BIGINT UNSIGNED AUTO_INCREMENT COMMENT 'Id of estate types.',
    name       VARCHAR(64) NOT NULL COMMENT 'Name of estate types.',
    active     TINYINT(1)  NOT NULL DEFAULT 0 COMMENT 'Status of deletion user.',
